      ...
      <div className="section-wrap">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[68px] items-start py-[88px]">
          ...
          <div>
            ...
            {[
              <>
                Eleje Legacy is a Nigerian non-governmental organisation founded
                in Ebonyi, Ebonyi State, in 2024. We work at the intersection of{" "}
                <strong style={{ color: "var(--deep)", fontWeight: 600 }}>
                  maternal health, early childhood development, and community
              ...
              <>
                ...
                — means "one who nurtures" in the Igbo tradition. It reflects
                our conviction that true development begins with the
                mother-child relationship, and that communities flourish when
                women are empowered, children are nourished, and legacies are
                intentionally built.
              </>,
              <>
                We are{" "}
                ...
                . Every programme we run is co-created with the communities we
                serve. We do not impose solutions from the outside — we sit with
                families, listen to their needs, and build responses that are
                dignified, sustainable, and locally owned.
              </>,
              <>
                Our vision is a Nigeria where no mother faces the journey of
                parenthood alone, and where every child — regardless of
                circumstance —{" "}
                <strong style={{ color: "var(--deep)", fontWeight: 600 }}>
                  inherits a future worth living
                </strong>
                .
              </>,
            ].map((para, i) => (
