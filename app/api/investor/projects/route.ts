...
// GET /api/investor/projects — active projects for investors to browse
export const GET = apiAuth(async (req: NextRequest & { user: any }) => {
  ...
  try {
    ...
    const where: Prisma.ProjectWhereInput = {
      status: "ACTIVE", // investors only see active projects
    ...
    console.error("[GET /api/investor/projects]", err);
